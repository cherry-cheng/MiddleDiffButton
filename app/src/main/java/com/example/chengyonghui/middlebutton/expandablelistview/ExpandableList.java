package com.example.chengyonghui.middlebutton.expandablelistview;
...
public class ExpandableList extends ExpandableListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SimpleExpandableListAdapter sela = new SimpleExpandableListAdapter(
                this, groups, R.layout.expandable_group,
                new String[] {"group"},
                new int[] {R.id.groupTo}, childs,
                R.layout.expandable_child, new String[] {"child"},
